...
logger "Starting Minecraft Bedrock Server Installation Script..."
...
if [ -d $MINECRAFT_BEDROCK_DIR ]; then
    ...
    DOWNLOAD_URL="https://minecraft.azureedge.net/bin-linux/bedrock-server-1.21.3.01.zip" # REPLACE WITH DESIRED VERSION
